    ...
    do
        ...
        local _, cogShow = EllesmereUI.BuildCogPopup({
            ...
            rows = {
                ...
                { type = "dropdown", label = "Position", values = POS_VALUES, order = POS_ORDER,
                  get = function() return BVal("durTextAnchor", "center") end, set = function(v) BSet("durTextAnchor", v) end },
    ...
    do
        ...
        local _, cogShow = EllesmereUI.BuildCogPopup({
            ...
            rows = {
                ...
                { type = "dropdown", label = "Position", values = POS_VALUES, order = POS_ORDER,
                  get = function() return BVal("stacksAnchor", "bottomright") end, set = function(v) BSet("stacksAnchor", v) end },
                { type = "slider", label = "Offset X", min = -20, max = 20, step = 1,
    ...
    do
        ...
        local _, cogShow = EllesmereUI.BuildCogPopup({
            ...
            rows = {
                ...
                { type = "dropdown", label = "Position", values = POS_VALUES, order = POS_ORDER,
                  get = function() return string.lower(p.debuffDurTextAnchor or "CENTER") end,
                  set = function(v) p.debuffDurTextAnchor = v; DmApply() end },
                { type = "slider", label = "Offset X", min = -20, max = 20, step = 1,
    ...
    do
        ...
        local _, cogShow = EllesmereUI.BuildCogPopup({
            ...
            rows = {
                ...
                { type = "dropdown", label = "Position", values = POS_VALUES, order = POS_ORDER,
                  get = function() return string.lower(p.debuffStacksTextAnchor or "BOTTOMRIGHT") end,
                  set = function(v) p.debuffStacksTextAnchor = v; DmApply() end },
                { type = "slider", label = "Offset X", min = -20, max = 20, step = 1,
        ...
        do
            ...
            local _, cogShow = EllesmereUI.BuildCogPopup({
                ...
                rows = {
                    ...
                    { type = "dropdown", label = "Position", values = POS_VALUES, order = POS_ORDER,
                      get = function() return TEff("durTextAnchor", "debuffDurTextAnchor", "center") end,
                      set = function(v) TSet("durTextAnchor", v) end },
                    { type = "slider", label = "Offset X", min = -20, max = 20, step = 1,
        ...
        do
            ...
            local _, cogShow = EllesmereUI.BuildCogPopup({
                ...
                rows = {
                    ...
                    { type = "dropdown", label = "Position", values = POS_VALUES, order = POS_ORDER,
                      get = function() return TEff("stacksTextAnchor", "debuffStacksTextAnchor", "bottomright") end,
                      set = function(v) TSet("stacksTextAnchor", v) end },
                    { type = "slider", label = "Offset X", min = -20, max = 20, step = 1,
